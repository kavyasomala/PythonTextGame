...
if answer.lower() in affirmative_answers:
  ...
  print("This textbased game will take you on an adventure through a series of yes or no answers.  but could be fun anyway if you're ready to give it a try!\n")

print("\n In this text based roleplaying game, you (the player) will have a chance to navigate the world in Dr. Sunshine's Sublime Circus through a series of yes or no answers. You will get the chance to be whisked away to a festive circus nestled in a whimsical, verdant valley. After discovering a great and dangerous secret about the circus, you must try and escape the piercing gaze of Dr. Sunshine's true, terrifying form. Will you be able to get out, or will you become a more permanent fixture of the circus?\n")
...
print("\nYou and your group find yourself in a tavern. Though it wouldn't have been renowned for it's interior decorating, it holds an undeniable allure that drew your party to it. You notice the bright colorful posters plastered across the walls of the tavern. All of them identical, featuring a a sharp featured, half-masked man. From the distance, you can see that the posters say, 'Come one, come all! Got a case of the blues? Visit Dr.Sunshine's Sublime Circus of Wonder and Awe. He'll fix you right up!'")
